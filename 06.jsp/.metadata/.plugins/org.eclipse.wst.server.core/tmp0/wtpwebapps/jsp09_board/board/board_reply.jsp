...
<body>
	<div class="container" align="center">
		...
		<form action="boardReply.bo" method="post" clsass="form-group input-group">
			...
			<div class="form-group input-group">
				<input type="text" name="bno" value="${board.getBno()}"/>
				<input type="text" name="re_ref" value="${board.getRe_ref()}"/>
				<input type="text" name="re_lev" value="${board.getRe_lev()}"/>
				<input type="text" name="re_seq" value="${board.getRe_seq()}"/>
